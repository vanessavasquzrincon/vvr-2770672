...
<?php echo $__env->make('layouts.menuburger', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="register create">
        ...
        <form action="<?php echo e(route('users.store')); ?>"  method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="fullname" placeholder="Full Name" value="<?php echo e(old('document')); ?>" >
            ...
            <input type="date" name="birthdate" placeholder="birthdate" value="<?php echo e(old('document')); ?>">
            <input type="text" name="phone" placeholder="Phone Number" value="<?php echo e(old('document')); ?>" >
            <input type="email" name="email" placeholder="Email" value="<?php echo e(old('document')); ?>" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AUTOCAD\Desktop\vvr-2770672\04-laravel\larapp\resources\views/users/create.blade.php ENDPATH**/ ?>